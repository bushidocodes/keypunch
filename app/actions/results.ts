...
export const setResultsContent = (resultsContent: string) => ({
  type: SET_RESULTS_CONTENT,
  resultsContent,
});
export const setJobStatus = (jobStatus: string) => ({
  type: SET_JOB_STATUS,
  jobStatus,
});
...
export const setIsSubmitted = (isSubmitted: boolean) => ({
...
export const setIsRetrieved = (isRetrieved: boolean) => ({
  type: SET_IS_RETRIEVED,
  isRetrieved,
});
export const setIsRetrieving = (isRetrieving: boolean) => ({
  type: SET_IS_RETRIEVING,
  isRetrieving,
});
export const setIsDisconnected = (isDisconnected: boolean) => ({
  type: SET_IS_DISCONNECTED,
  isDisconnected,
});
export const setIsDisconnecting = (isDisconnecting: boolean) => ({
